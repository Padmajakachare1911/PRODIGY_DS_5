...
# Univariate Analysis - Analyze accident frequency by time of day, weather, and road conditions
...
# Step 5: Bivariate Analysis - Analyze the interaction between weather, road conditions, and accident time
plt.figure(figsize=(10, 6))
